...
// What reduce does is:
  ...
  // 5. The result returned from the previous iteration is now passed in
  //      as the accumulated result to the next iteration.
  // 6. reduce returns the final accumulated value for us.

// An obvious way of using reduce is to sum up the values in an array.
// That would look like so:
  ...
  // We're creating a variable sum,
    ...
    // Those arguments are the testArr we just created, and a callback function.
      ...
      // This result is then passed in as accumulated
